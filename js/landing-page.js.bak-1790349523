/* ============================================================= */
/* LANDING-PAGE.JS — Pullman Dakar Teranga                       */
/* Affiche le loader UNE SEULE FOIS par session                  */
/* ============================================================= */
(function () {
    'use strict';
    ...
    var HTML =
      '<div class="lp-inner">' +
        '<div class="lp-orb-wrap">' +
          ...
          '</svg>' +
        '</div>' +
        '<svg class="lp-wordmark" viewBox="670.34 536.84 331.73 53.31">' +
          ...
          '<path d="M948.18,573.25h-4v-4l-2.06,1.28c-7.1,4.54-17.35,4.58-23.73.09a11.74,11.74,0,0,1,.41-19.92c6.55-4.2,18-3.94,24.37.6a11,11,0,0,1,5,8.72C948.31,564.36,948.18,568.69,948.18,573.25Z"/>' +
